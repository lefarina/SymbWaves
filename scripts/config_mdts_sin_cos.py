...
processed_df_path = os.path.join(PROJECT_ROOT, 'data', 'processed', 'era5_structured_mdts_sin_cos.csv')



# ===========================
#  GENERAL SETTINGS (or create this section)
# ===========================
use_vectorized = True 
